...
\begin{sloppypar}
    ...
    Filterkretsen designades genom att räkna ut värden på resistorer genom att välja en bandbredd och centerfrekvens med ett avstånd på cirka $15$~kHz från fingret innan där första fingrets centerfrekvens var $100$~kHz.
    ...
    Det visade sig att formlerna för resistorerna
    antog att operationsförstärkare var ideal för att kretsen skulle fungera, vilket inte hade räknats med.
    ...
    Filterkretsen gav vid test i verkligheten en oigenkänbar signal.
    ...
    Lärdomar vi drar från dessa kretsdimensioneringar är att inte använda sig av ideala komponenter, och försöka säkerställa att de formler man räknar med också fungerar med icke-ideala komponenter. Att också se till att ens komponenter har rätt värden, genom att göra flera separata mätningar kan spara mycket tid, så att man snabbt kan gå vidare till att utföra det man planerat, så att man har tid att åtgärda problem.
