...
\begin{sloppypar}
    ...
    Efter förslag utifrån om att integrera spolarna i kretsen som en resonanskälla byttes oscillatorerna mot 555-oscillatorer.
    ...
    Istället för att använda ett 555-chip användes ett 556-chip, som har samma funktioner som två stycken 555:or; en på varje sida av komponenten, och som drar mindre effekt.
