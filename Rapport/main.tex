...
\begin{sloppypar}
    ...
    \subsection{Kretsar}
    \subsubsection{Filter}
    Filterkretsen är ett aktivt bandpassfilter.
    ...
    läser sedan av värdena från de olika sensorerna och publicerar dessa till ett Bluetooth characteristics.
    ...
    För att kommunicera med mikrokontrollen används BleWinrtDll och hand modellen kommer från Ultraleaps UnityPlugin.
